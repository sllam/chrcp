...
class Inspector:
	...
	@visit.on('dec')
	def filter_decs(self, dec, ensem=False, extern=False, execute=False, fact=False, rule=False, assign=False, init=False, exist=False, loc_facts=False):
		pass
	...
	def filter_decs(self, dec, ensem=False, extern=False, execute=False, fact=False, rule=False, assign=False, init=False, exist=False, loc_facts=False):
		...
		for d in dec:
			decs += self.filter_decs(d, ensem=ensem, extern=extern, execute=execute, fact=fact, rule=rule, assign=assign, init=init
                                                ,exist=exist, loc_facts=loc_facts)
		return decs
